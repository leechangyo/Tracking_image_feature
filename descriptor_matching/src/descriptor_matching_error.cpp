                      ...
                      vector<cv::DMatch> &matches, string descriptorType, string matcherType, string selectorType)
{
    ...
    // vector<std::vector<DMatch>> matcher;
    ...
    else if (matcherType.compare("MAT_FLANN") == 0)
    {
        ...
        //... TODO : implement FLANN matching(Knearest neighbor)
    ...
    { // k nearest neighbors (k=2)
        ...
        for (auto it = knn_matches.begin(); it != knn_matches.end(); ++it)
        {
            ...
            if ((*it)[0].distance < minDescDistRatio * (*it)[1].distance) //image 1 macthing distance and image 2 maching distance
            {
...
int main()
{
    ...
    readDescriptors("../dat/C35A5_DescRef_BRISKs_small.dat", descRef);
